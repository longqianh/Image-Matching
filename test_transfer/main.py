...
class Arg(object):
  ...
  def set_anchor(self, img_name):
    ...
    self.data.append(self.anchor)
    # kps,sc,desc = self.superpoint(anchor_tensor)
    # self.anchor_features.append(kps)
    # self.anchor_features.append(sc)
    # self.anchor_features.append(desc)
    # self.data = {**self.data, "keypoints0":anchor_features[0],"scores0":anchor_features[1],"descriptors0":anchor_features[2]}
  ...
  def set_match(self, match_name):
    ...
    self.match=match_tensor
    self.data.append(self.match)
    # kps,sc,desc = self.superpoint(match_tensor)
    # self.anchor_features.append(kps)
    # self.anchor_features.append(sc)
    # self.anchor_features.append(desc)
